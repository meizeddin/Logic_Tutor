 ...
 */
public class DisjunctionExpressionNode implements ExpressionNode
{
	 ...
	 * Default constructor.
	 */
	public DisjunctionExpressionNode(ExpressionNode left, ExpressionNode right)
	{
		this.left = left;
		this.right = right;
	}
	...
	public int getType()
	{
		return ExpressionNode.DISJUNCTION_NODE;
	}
