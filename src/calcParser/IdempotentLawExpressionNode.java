...
public class IdempotentLawExpressionNode implements ExpressionNode
{
	 ...
	 * Default constructor.
	 */
	public IdempotentLawExpressionNode(ExpressionNode left, ExpressionNode right)
	{
		this.left = left;
		this.right = right;
	}
	...
	public int getType()
	{
		return ExpressionNode.CONJUNCTION_NODE;
	}
